...
__webpack_require__.consumesLoadingData = { chunkMapping: {"987":[],"512":[],"425":["866"],"611":["725"]}, moduleIdToConsumeDataMapping: { "725": { shareScope: "default", shareKey: "react", import: "react", requiredVersion: "^18.2.0", strictVersion: false, singleton: true, eager: false, fallback: function() { return __webpack_require__.el("725@").then(function() { return function() { return __webpack_require__(/*! react */"294"); }; }); } }, "866": { shareScope: "default", shareKey: "react-dom", import: "react-dom", requiredVersion: "^18.2.0", strictVersion: false, singleton: true, eager: false, fallback: function() { return __webpack_require__.el("866@").then(function() { return function() { return __webpack_require__(/*! react-dom */"935"); }; }); } } }, initialConsumes: [] };
